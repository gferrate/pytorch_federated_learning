def extract_results(fn, num_epochs):
    data = {}
    last_epoch = -1
    clustering = False
    with open(fn, 'r') as f:
        for l in f:
            ...
            if l.startswith('Test'):
                ...
                # Epochs go from 0 to num_epochs - 1. epoch == num_epochs is the final testing
...
if __name__ == '__main__':
    num_epochs = 30
    fn = 'results_non_fedlearn.results'
    data = extract_results(fn, num_epochs)
    average_epochs(data)
    print(data[30])
